const IMPORTANT_ROLES = [
    "Area", "Single Target", 
    "Heal", "Shield", "Positioning", "Resurection",
...
const OPTIONAL_ROLES = [
    ...
    "Sub Shield", "Sub Heal", "Sub DPT", "Sub Tank", "Sub Positioning", "Off Tank",
...
const CATEGORIES = {
    ...
    'Sub Roles': ["Off Tank", "Sub Shield", "Sub Heal", "Sub DPT", "Sub Positioning"],
