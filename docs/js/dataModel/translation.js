...
dpt_ranged_single_target: {
    fr: 'DPT Distance Monocible',
    en: 'DPT Ranged Single Target'
},
dpt_melee: {
    fr: 'DPT Mêlée',
    en: 'DPT Melee'
},
dpt_melee_single_target: {
    fr: 'DPT Mêlée Monocible',
    en: 'DPT Melee Single Target'
},
dpt_melee_area: {
    fr: 'DPT Mêlée Zone',
    en: 'DPT Melee Area'
...
export { LANGUAGES, TRANSLATIONS, translate };